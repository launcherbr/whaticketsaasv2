...
const useStyles = makeStyles((theme) => ({
    ...
    header: {
        display: "flex",
        borderBottom: "1px solid rgba(0, 0, 0, 0.12)",
        backgroundColor: theme.palette.contactdrawer, //DARK MODE WHATICKET//
        alignItems: "center",
                ...
                {loading ? (
                    ...
                    <div className={classes.content}>
                        ...
                        <Paper square variant="outlined" className={classes.contactDetails}>
                            ...
                            ></ContactModal>
                            <Typography variant="subtitle1">{i18n.t("contactDrawer.extraInfo")}</Typography>
                            {contact?.extraInfo?.map((info) => (
                                <Paper key={info.id} square variant="outlined" className={classes.contactExtraInfo}>
